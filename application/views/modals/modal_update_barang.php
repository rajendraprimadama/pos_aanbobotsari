<form id="form-update-barang" method="POST">
    <div class="modal-content">
        <div class="modal-header">
            <h3 class="modal-title text-center text-bold">Update Data Barang</h3>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="text" class="form-control" placeholder="Nama Barang" name="v_namabrg"
                    ...
                    <fieldset>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control FormatKey text-right v_hargabeli_renteng_update"
                    ...
                    <div class="row">
                        ...
                        <fieldset>
                            ...
                            <input type="text" class="form-control FormatKey text-right sell_update v_renteng_hrgjual_retail_update"
                        ...
                        <fieldset>
                            ...
                            <input type="text" class="form-control FormatKey text-right sell_update v_renteng_hrgjual_grosir_update"
                    ...
                    <div class="form-group">
                    <textarea class="form-control v_keterangan" id="v_keterangan" name="v_keterangan" placeholder="Keterangan" rows="1"><?php echo $dataBarang->keterangan; ?></textarea>
                    </div>
