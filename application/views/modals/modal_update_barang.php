  ...
  <form id="form-update-barang" method="POST">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="form-group">
          <textarea class="form-control text-uppercase v_keterangan" id="v_keterangan" name="v_keterangan" placeholder="Keterangan" rows="3"><?php echo $dataBarang->keterangan; ?></textarea>
        </div>
