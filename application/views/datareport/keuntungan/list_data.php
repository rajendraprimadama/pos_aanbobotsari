        ...
        foreach ($datatable as $key => $val) {
            ?>
                <tr>
                    ...
                    <td class="text-right"><?php echo $controller->FormatNumber($val->Modal); ?></td>
                    <td class="text-right"><?php echo $controller->FormatNumber($val->Total_HargaJual); ?></td>
                    <td class="text-right"><?php echo $controller->FormatNumber($val->Total_HargaJual - $val->Modal); ?></td>
                </tr>
